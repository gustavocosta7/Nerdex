            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="form-group">
                            <label>ID</label>
                            <input name="tfId" class="form-control" type="number" disabled value="${produto.proid}" readonly="readonly">
                    </div>                        
                    <div class="form-group">
                        <label>Nome</label>
                        <input class="form-control" type="text" name="tfNome" disabled value="${produto.pronome}">
                    </div>

                    <div class="form-group">
                        <label>Preço</label>
                        <input class="form-control" type="text" name="tfPreco"disabled  value="${produto.propreco}">
                    </div>  <div class="form-group">
                        <span for="idDesc">Descrição</span>
                        <textarea name="tfDesc"  id="idDesc" class="form-control" disabled>${produto.prodes}</textarea>
                    </div>
                    <div>
                    </div>
